...
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `#include <stdio.h>`                  | Includes the standard input/output library. Parsing whatever 'include' is referencing directly underneath the include line, printed line for line. |
| `#define NAME value`                  | Defines a constant macro, being replacing all instances of the name with the value.                                                                |
...
_Figure 2.1.2: The complete structure of a simple C program._
...
_Figure 2.1.8: Description of the origin of rule 4

![[Pasted image 20250917194347.png]]
_Figure 2.1.9: A table summarizing valid identifiers._
...
_Figure 2.2.7: Examples of valid `char` constants._
...
_Figure 2.2.6: A table comparing the signed and unsigned types._
