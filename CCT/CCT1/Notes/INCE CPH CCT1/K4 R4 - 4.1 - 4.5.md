...
Using [[CCT/CCT1/Notes/INCE CPH CCT1/K3 R3 - 3.1 - 3.2 + 3.5#3.2 The Map Method|Karnaugh maps]] for each output variable, we obtain the simplified Boolean functions:
