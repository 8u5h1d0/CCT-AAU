...
public class CastingDemo {
    ...
    public static void main(String[] args) {
        ...
        PolyVehicle v1 = b1; // Upcasting sker automatisk (sikkert)
        ...
        // Vi må eksplicit fortælle Java: "Jeg lover, at v2 faktisk er en cykel"
        ...
        // Hvis vi fjernede udkommenteringen herunder, ville koden kompilere fint, 
        // men CRASHE med en ClassCastException når vi kører den!
